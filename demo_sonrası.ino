...
int star_pos=data.indexOf('*');
String distance_str= data.substring(0,comma_pos);
distance=distance_str.toInt();
String angle_str=data.substring(comma_pos+1,star_pos());
angle = angle_str.toInt();

String direct=data.substring(star_pos+1,data.length());
